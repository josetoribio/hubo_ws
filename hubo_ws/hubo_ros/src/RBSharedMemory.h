...
typedef struct _RBCORE_SHM_SENSOR_
{
    ...
    int             Sim_Time_sec;
    int             Sim_Time_nsec;
    unsigned char   TFB_Right_Voltage;
    unsigned char   TFB_Right_DOUT[2];
    unsigned char   TFB_Right_DIN[6];
    unsigned char   TFB_Left_Voltage;
    unsigned char   TFB_Left_DOUT[2];
    unsigned char   TFB_Left_DIN[6];
...
typedef struct _RBCORE_SHM_COMMAND_
{
    ...
    int             MELK_ACTION_INFO;

    bool            VISION_DATA_ISNEW;
    int             VISION_DATA_TYPE;
    double          VISION_DATA_PX;
    double          VISION_DATA_PY;
    double          VISION_DATA_PZ;
